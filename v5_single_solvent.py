...
"""
ratioAGG: 是以K+为中心, 看其溶剂化壳层中的FSI-及溶剂的配位情况
ratioAGGFSI: 是以FSI-为中心, 看其溶剂化壳层中的K+的配位情况 (拉曼)
ratioCN: 是以K+为中心, 看其溶剂化壳层中的溶剂和FSI-的配位和配位数的情况, ratioCN的键值对统计后应该与ratioAGG的键值对统计相等
